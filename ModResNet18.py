...
class ModResNetBlock(tf.keras.Model):
    def __init__(self, num_filters, kernel_size=3, padding='same', trainable=False, cat=True):
        ...
        self.drop_1_1 = layers.Dropout(0.1)
        ...
        self.drop_1_2 = layers.Dropout(0.1)
        ...
        self.drop_1_4 = layers.Dropout(0.1)
        ...
        self.drop_1_8 = layers.Dropout(0.1)
        ...
        self.drop_2_1 = layers.Dropout(0.1)
        ...
        self.drop_2_2 = layers.Dropout(0.1)
        ...
        self.drop_2_4 = layers.Dropout(0.1)
        ...
        self.drop_2_8 = layers.Dropout(0.1)
...
if __name__ == '__main__':
    model = ModResNet18Classify(1, trainable=True)
